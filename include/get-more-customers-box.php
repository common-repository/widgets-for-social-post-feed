...
?></div>
<a class="ti-btn" href="https://www.trustindex.io/ti-redirect.php?url=/feed-widgets&a=sys&c=<?php echo esc_attr($tiCampaign1); ?>" target="_blank"><?php echo esc_html(__('Create a Free Account for More Features', 'widgets-for-social-post-feed')); ?></a>
...
<li>
<strong><?php echo esc_html(__('Automatically update with new posts', 'widgets-for-social-post-feed')); ?></strong><br />
<?php echo esc_html(__('Wordpress cannot update posts, but Trustindex can! As soon as you have new posts, Trustindex automatically adds them to your widget. Customers love fresh content!', 'widgets-for-social-post-feed')); ?>
</li>
<li>
...
<a class="ti-btn" href="https://www.trustindex.io/url=/feed-widgets&ti-redirect.php?a=sys&c=<?php echo esc_attr($tiCampaign2); ?>" target="_blank"><?php echo esc_html(__('Create a Free Account for More Features', 'widgets-for-social-post-feed')); ?></a>
