...
echo wp_kses_post($this->errorBoxForAdmins(__('Could not download the posts for the widget.<br />Please reload the page.<br />If the problem persists, please write an email to support@trustindex.io.', 'widgets-for-social-post-feed') .'<br /><br />'. print_r($response, true)));
die;
}
...
$newItem1 = '<a href="' . admin_url('admin.php?page=' . $this->getPluginSlug() . '/admin.php') . '">' . __('Settings', 'widgets-for-social-post-feed') . '</a>';
...
{
if (basename($file) === $this->getPluginSlug() . '.php') {
$meta[] = '<a href="http://wordpress.org/support/view/plugin-reviews/'. $this->getPluginSlug() .'" target="_blank" rel="noopener noreferrer">'. __('Rate our plugin', 'widgets-for-social-post-feed') . '</a>';
}
return $meta;
}
